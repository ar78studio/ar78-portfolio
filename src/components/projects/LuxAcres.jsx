      ...
      <div className='relative'>
        ...
        >
          ...
          <p className='px-5 pt-0 text-[0.6rem] sm:text-sm font-base font-roboto text-blueDianne'>
            LuxAcres is a fictional website which I designed and created a mock
            up of, for the
            <a
            ...
            demonstrate my knowledge of layout and CSS as well as ability to use
          ...
          <p className='px-5 text-[0.6rem] sm:text-sm font-base font-roboto text-blueDianne'>
            ...
            Pandemic, to work with Front-End and some Back-End in C# and Asp.net
            environment. Thus the internship that I held was going to transition
            into this position, but due to the lockdowns this has not played
            out.
          </p>
          <p className='px-5 text-[0.6rem] sm:text-sm font-base font-roboto text-blueDianne'>
            I enjoyed very much working on this project, as it provided an
            opportunity to direct myself from the initial concept to design and
            production.
          </p>
        </div>
        <img
