        ...
        <div className='relative'>
          ...
          >
            ...
            <p className='px-5 pt-0 text-[0.6rem] sm:text-sm font-base font-roboto text-blueDianne'>
              This app allows you to create an invoice and email it to a client.
              It uses local-storage methods to keep the data you have entered
              until cleared the form. Built with HTML, CSS and JavaScript
            </p>
          </div>
          <img
            src={invoiceImg}
