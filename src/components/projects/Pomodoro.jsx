    ...
    absolute h-fit w-fit border-box projectBgWhite m-[2rem] mt-[2rem] sm:mt-[4rem] p-2 sm:p-4 rounded-md z-[99]`}
        >
          ...
          <p className='px-5 pt-0 text-[0.6rem] sm:text-sm font-base font-roboto text-blueDianne'>
            This app is an advanced Front End Mentor challenge, which I took on
            to test my ability to work with "advanced" projects as a beginner
            developer. The user is able to set a Pomodoro timer and short & long
            break timers. Customize how long each timer runs for. See a circular
            progress bar that updates every minute. Customize the appearance of
            the app with the ability to set preferences for colors and fonts.
          </p>
          <p className='px-5 text-[0.6rem] sm:text-sm font-base font-roboto text-blueDianne'>
            ...
            conclusion that "advanced" is only a name of the mountain until one
            begins to climb it.
          </p>
        </div>
        <img
