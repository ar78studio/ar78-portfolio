		...
		<div className={`flex flex-col`}>
			...
			<div className={`flex w-fit mr-4`}>
				...
				<span className={`text-blueDianne flex flex-wrap font-bold text-[0.8rem] mt-4 sm:text-[1rem] md:text-[1.2rem] mr-2 sm:mr-30 lg:mr-40 sm:pb-20 pb-20 lg:pb-40`}>
					{
						"I'm a passionate and thirsty Web and Graphic Designer + Developer with experience in both Wordpress and Front-End Technologies, who strives to produce clean code + inspiring design driven by the client's vision."
					}
				</span>
			</div>
		</div>
